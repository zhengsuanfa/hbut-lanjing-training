          ...
          <div className="text-center">
            ...
            <div className="mb-6 flex justify-center">
              <div className="relative">
                <img src={logoImage} alt="蓝鲸艺术协会培训记录站" className="w-24 h-24 object-contain" />
              </div>
            </div>
            
            <h1 className="mb-6 text-white tracking-tight">蓝鲸艺术协会培训记录站</h1>
            <div className="w-16 h-0.5 bg-blue-300 mx-auto mb-6"></div>
            <p className="text-blue-100 tracking-wide opacity-90">Blue Whale Art Association Training Archive</p>
          </div>
        </div>
